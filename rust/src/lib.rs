//! Windissect-generated Rust FFI bindings for AppExtension.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "7B71744CB4C28E44F0AF38E637993305";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2442977994;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 17] = [65, 112, 112, 69, 120, 116, 101, 110, 115, 105, 111, 110, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2442977994 { return 0; }
