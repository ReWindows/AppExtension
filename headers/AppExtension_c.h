// Flat C exports observed in AppExtension.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef APPEXTENSION_C_H
#define APPEXTENSION_C_H
